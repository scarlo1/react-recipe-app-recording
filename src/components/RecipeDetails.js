...
//		this.state = {
//			recipe: recipe,
//			url: `https://www.food2fork.com/api/get?key=753b7f06162c80857ddb94800030a2f2&rId=${this.props.id}`
//		};
//	}
//	
...
//	}
	...
	async componentDidMount() {
		...
		const url = `https://www.food2fork.com/api/get?key=753b7f06162c80857ddb94800030a2f2&rId=${id}`;
		try {
